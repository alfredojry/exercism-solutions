...
def check_drinks(drink_name, drink_ingredients):
    ...
    """
    return f'{drink_name} {'Cocktail' if not ALCOHOLS.isdisjoint(drink_ingredients) else 'Mocktail'}'
...
def separate_appetizers(dishes, appetizers):
    ...
    """
    return list(set(dishes).difference(list(appetizers)))
